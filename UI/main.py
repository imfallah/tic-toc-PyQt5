...
class Game(QMainWindow, Ui_tictactoe):
    ...
    def __init__(self, parent=None):
        ...
        self.sounds = dict(circle=QSound("sound/circle.wav"),
                           cross=QSound("sound/cross.wav"),
                           win=QSound("sound/win.wav"),
                           lose=QSound("sound/lose.wav"))

        xIconPath = os.path.join("Icons", "x1.png")
        oIconPath = os.path.join("Icons", "o1.png")
